...
class DataProcess:
    ...
    def load_data(self, paths, mode='train'):
        ...
        for idx, each_folder_name in enumerate(folder_name_list):
            ...
            t2nd_path = os.path.join(paths[0]+'_KNN_t2no_10', '_out_{}'.format(each_folder_name))
            ...
            for c_dir in c_dir_list:
                ...
                # print(c_dir_path, frame_np.shape)
                # assert frame_im.shape == [], 'c_dir_path: {}, frame_np.shape: {}'.format(c_dir_path, frame_np.shape)
