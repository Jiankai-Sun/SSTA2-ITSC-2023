...
class DataProcess:
    ...
    def load_data(self, paths, mode='train'):
        ...
        '''
        # left
        path = os.path.join(paths[0], '_out_0')
        ...
        # new_data = np.zeros((frames_np.shape[0], self.image_width, self.image_width, self.img_channel))
        new_data = data
        ...
        # right
        path = os.path.join(paths[0], '_out_1')
        print('begin load data ' + str(path))
